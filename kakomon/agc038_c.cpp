...
int main()
{
  ...
  cin >> N;
  vector<modint> A(N);
  vector<modint> counts(1000000+1,0);
  vector<modint> sumA(1000000+1);
  vector<modint> sumAA(1000000+1);
  vector<modint> answers(1000000+1);
  for(int i = 0;i < N;i++){
    cin >> A[i];
    counts[A[i].x]+= 1;
  }
  ...
  for(ll i = 1;i <= 1000000;i++){
    for(ll j = 1;i*j <= 1000000;j++){
        sumA[i] += counts[i*j]*i*j;
        sumAA[i] += counts[i*j]*i*j*i*j;
    }
  }
  modint ans = 0;
  for(ll i = 1000000;i >= 1;i--){
    modint current = (sumA[i]*sumA[i]- sumAA[i]);
