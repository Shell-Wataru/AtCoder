...
modint count(ll x)
{
    ...
    while (true)
    {
        if (power <= x/10)
        {
            // cout << power << ":" << (power + 10 * power - 1) << endl;
            if (power %  2 == 0){
                ans += base * (power + 10 * power - 1) * ((9 * power) / 2);
            }else{
                ans += base * ((power + 10 * power - 1) / 2) * (9 * power);
            }
            power *= 10;
            base += 1;
        }
        ...
        {
            if ((power + x) % 2 == 0){
                ans += base * ((power + x)/2) * (x - power + 1);
            }else{
                ans += base * (power + x) * ((x - power + 1) / 2);
            }
            break;
        }
    }
