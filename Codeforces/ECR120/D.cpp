...
int solve()
{
  ...
  if (contains_k != k+2 || k==0){
    cout << 1 << "\n";
    return 0;
  }
  modint ans = C.C(r - l - 2, k);
  // cout << S << endl;
  // cout << l << "~" << r << endl;
  while (r < n)
  {
    ...
    // cout << l << "~" << r << endl;
    ans += C.C(r - l - 2, k) - C.C(old_r - l - 2, k - 1);
  }
  // ans += C.C(r - l - 1, k - 1) - C.C(r - l, k);
  cout << ans << "\n";
  return 0;
}
